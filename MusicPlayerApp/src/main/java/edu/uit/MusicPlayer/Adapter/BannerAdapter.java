...
public class BannerAdapter extends PagerAdapter {
    ...
    public Object instantiateItem(@NonNull ViewGroup container, final int position) {
        ...
        Picasso.with(context).load(arrayListbanner.get(position).getHinhanh()).centerCrop().fit().into(imgbackgroundbanner);
        Picasso.with(context).load(arrayListbanner.get(position).getHinhBaiHat()).centerCrop().fit().into(imgsongbanner);
